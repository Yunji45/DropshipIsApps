...
<body>
  ...
  <div class="container-fluid">
    <span class="navbar-brand mb-0 h1"> Dropship Edans </span>
  </div>

    <nav class="navbar navbar-expand-lg navbar-light bg-light" text-center= middle  >
    <div class="container-fluid" >
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
            <a class="nav-link" href="Detail">det</a>
            </li>
            <li class="nav-item">
